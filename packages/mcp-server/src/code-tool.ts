...
import PiercesStagingTesterMcHere, { ClientOptions } from 'pierces-staging-tester';
...
export async function codeTool(): Promise<Endpoint> {
  ...
  const handler = async (client: PiercesStagingTesterMcHere, args: unknown): Promise<ToolCallResult> => {

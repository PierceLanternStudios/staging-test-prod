...
import { ClientOptions } from 'pierces-staging-tester';
...
export { ClientOptions } from 'pierces-staging-tester';
export { endpoints } from './tools';

export const newMcpServer = () =>
  new McpServer(
    {
      name: 'pierces_staging_tester_api',
      version: '1.0.1',
    },
...
export function initMcpServer(params: {
  ...
  let client = new PiercesStagingTesterMcHere({
    logger,

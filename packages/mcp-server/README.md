# Pierces Staging Tester Mc Here TypeScript MCP Server
...
npx -y pierces-staging-tester-mcp@latest
```
...
```json
{
  "mcpServers": {
    "pierces_staging_tester_api": {
      "command": "npx",
      "args": ["-y", "pierces-staging-tester-mcp", "--client=claude", "--tools=all"],
      "env": {
...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=pierces-staging-tester-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsInBpZXJjZXMtc3RhZ2luZy10ZXN0ZXItbWNwIl0sImVudiI6eyJQRVRTVE9SRV9BUElfS0VZIjoiU2V0IHlvdXIgUEVUU1RPUkVfQVBJX0tFWSBoZXJlLiJ9fQ)
...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22pierces-staging-tester-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22pierces-staging-tester-mcp%22%5D%2C%22env%22%3A%7B%22PETSTORE_API_KEY%22%3A%22Set%20your%20PETSTORE_API_KEY%20here.%22%7D%7D)
...
```
claude mcp add --transport stdio pierces_staging_tester_api --env PETSTORE_API_KEY="Your PETSTORE_API_KEY here." -- npx -y pierces-staging-tester-mcp
```
...
import { server, endpoints, init } from "pierces-staging-tester-mcp/server";

// import a specific tool
import createPets from "pierces-staging-tester-mcp/tools/pets/create-pets";

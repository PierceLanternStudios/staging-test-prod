import fs from 'fs';
import type { ResponseLike } from 'pierces-staging-tester/internal/to-file';
import { toFile } from 'pierces-staging-tester/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('pierces-staging-tester/core/uploads');
    await expect(
